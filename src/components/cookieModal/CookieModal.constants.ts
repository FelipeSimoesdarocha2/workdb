const cookieOptions = [
    {
        ...
        description:
            'Esses cookies permitem funcionalidades essenciais, tais como segurança, verificação de identidade e gerenciamento de rede. Esses cookies não podem ser desativados.',
    },
    {
        title: 'Ativar cookies de marketing',
        description:
    ...
    {
        title: 'Ativar cookies funcionais',
        description:
    ...
    {
        title: 'Ativar cookies analíticos',
        description:
